...
func TestAuthModuleConnectorIAMKeepsTargetsOwnOptions(t *testing.T) {
	...
	if got, want := iamConn.Options["application_name"], "myapp"; got != want {
		t.Errorf(`Options["application_name"] = %q, want %q`, got, want)
	}
}
...
func TestAuthModuleConnectorIAMOptionsOverrideTargetsOwnOptions(t *testing.T) {
	...
	if got, want := iamConn.Options["sslmode"], "verify-full"; got != want {
